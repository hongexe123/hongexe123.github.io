(function(){
	var Y = YUI,
	    ...
	    TIPS = {
			...
			mobile: {
				"tips": "请输入可以联系到您的手机号码！",
				"warn": "对不起，您填写的手机号码格式不正确！"
			},
			url: {
				"tips": "请输入网站地址！",
				"warn": "对不起，您填写的网站地址格式不正确！"
			},
			ip: {
				"tips": "请输入IP地址！",
				"warn": "对不起，您填写的IP地址格式不正确！"
			},
			currency: {
				"tips": "请输入金额！",
				"warn": "对不起，您填写的金额格式不正确！"
			},
			zip: {
				"tips": "请输入邮政编码！",
				"warn": "对不起，您填写的邮政编码格式不正确！"
			},
			qq: {
				"tips": "请输入您的QQ号！",
				"warn": "对不起，您填写的QQ号格式不正确！"
			},
			english: {
				"tips": "请输入英文字母！",
