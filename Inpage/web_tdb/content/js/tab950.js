...
myFocus.setting({style:'mF_tab',id:'qqTab',trigger:'mouseover',type:'slide',auto:true,time:2,width:600,height:106});myFocus.setting({style:'mF_tab',id:'qqTabAuto',trigger:'mouseover',type:'fade',auto:false,time:2,width:950,height:'auto'});myFocus.setting({style:'mF_tab',id:'myFocus1',trigger:'mouseover',type:'none',auto:false,time:2,width:400,height:61});myFocus.setting({style:'mF_tab',id:'myFocus2',trigger:'mouseover',type:'slide',auto:false,time:2,width:400,height:61});myFocus.setting({style:'mF_tab',id:'myFocus3',trigger:'mouseover',type:'fade',auto:false,time:2,width:400,height:61});myFocus.setting({style:'mF_tab',id:'myFocus4',trigger:'mouseover',type:'slide',auto:true,time:2,width:400,height:61});
